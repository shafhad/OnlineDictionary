...
export default class Germany extends React.Component {
  ...
  getWord = (word) => {
    var url = 'https://api.dictionaryapi.dev/api/v2/entries/de/' + word;
    return fetch(url)
      .then((data) => {
        return data.json();
      })
    ...
    return (
      ...
      <View>
        <Header
          ...
          centerComponent={{
            text: 'Online-Wörterbuch',

            style: {
              backgroundColor: '#F2D201',
              fontFamily: 'Rockwell',
              fontSize: 20,
            },
          }}
        ...
        <TextInput
          ...
          placeholder='Type a word In Germany!'
          onChangeText={(text) => {
            this.setState({
              text: text,
        ...
        <TouchableOpacity
          ...
          <Text style={styles.text1}> Suchen </Text>
        </TouchableOpacity>
